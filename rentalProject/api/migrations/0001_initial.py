    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('daily_price', models.FloatField(help_text='TRY')),
                ('weekly_price', models.FloatField(help_text='TRY')),
                ('is_active', models.BooleanField(default=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.category')),
                ('model', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.model')),
            ],
        ),
        migrations.CreateModel(
            name='Rent',
            fields=[
                ...
                ('uav', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.uav')),
            ],
        ),
    ]
